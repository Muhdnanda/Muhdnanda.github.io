...
const Template: React.FC<Props> = ({ children, name, email, wa }) => {

  return (
    <>
      <main className="dark:bg-gray-800 font-mono bg-white">
        {/* Topbar  */}
        <header className="h-24 flex items-center z-30 w-full">
          <div className="container mx-auto px-6 flex items-center justify-between w-full">
            <div className="text-gray-800 dark:text-white font-black text-3xl md:flex items-center hidden">
              ...
              <span className="text-xs ml-3 mt-1">{email?.replace("@", "[at]")}</span>
            </div>
            {/* Social */}
        ...
        <div className="flex items-center h-max">
          <div className="container mx-auto px-6 flex flex-col justify-between items-center pb-4">
            <div className="flex flex-col">
              ...
              <p className="md:text-3xl my-6 text-amber-400 text-center dark:text-white">
                Hi, I&#x27;m&nbsp;
                <Link
                  to="https://www.scopus.com/authid/detail.uri?authorId=57191890658"
                  className=" underline underline-offset-8 hover:text-sky-500">
                  {name}
                </Link>
              </p>
              <h4 className="max-w-3xl lg:text-2xl mx-auto dark:text-white text-zinc-500 text-center pt-2">
                Lecturer, researcher and surveyor.
              </h4>
              <h5 className="mx-auto lg:text-base dark:text-white text-zinc-500">
                Aceh, Indonesia
              </h5>
              {/* Interest */}
              <div className="mx-auto text-center max-w-xs sm:max-w-2xl lg:max-w-4xl mt-6">
                <h4 className="md:text-lg md:font-semibold">Research Interest</h4>
                <p>Geophysics, oceanography physics, environmental sciences, disaster and hazards mitigation.</p>
              </div>
              {/* Contact */}
              <div className="flex flex-col items-center justify-center py-4">
                <div className="capitalize py-2 mb-4 px-4 mt-6 bg-teal-600 rounded-full dark:bg-white text-zinc-50 dark:text-white">
                  Connect with me
                </div>
                <div className="flex gap-4">
                  ...
                  <Link
                    to={`https://wa.me/${wa}?text=Hello+${name}`}
                    target="_blank"
                    className="flex gap-2 hover:text-sky-500"
                  >
